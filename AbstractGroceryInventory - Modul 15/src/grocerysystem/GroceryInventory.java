...
public class GroceryInventory {
    ...
    public static void main(String[] args) throws ExpiredProductAddedException { // Opagve 3 modul 15
    ...
    private static FoodProduct foodProductCreator(String name, double price, long expOffsetMs, int temp) throws ExpiredProductAddedException { // opgave 3 modul 15
        Date d = new Date();
